...
export const initialClinic = {
  ...
  defaultWorkflow: {
    ...
    steps: [
      ...
      { id: 'ws_2',     type: 'intake_form', label: 'Intake Form' },
      { id: 'ws_3', type: 'conditional', label: 'By Patient Type', conditionType: 'patient_type', branches: [
        ...
        { id: 'wb_2', label: 'Insurance', condition: 'insurance', steps: [
          { id: 'ws_3b', type: 'insurance_form', label: 'Insurance' },
      ...
      { id: 'ws_4',     type: 'pharmacy', label: 'Pharmacy' },
      { id: 'ws_5',     type: 'emergency_contact', label: 'Emergency Contact' },
    ...
    visitOptions: [
      {
        ...
        workflowOverride: {
          ...
          steps: [
            ...
            { id: 'mh_2', type: 'intake_form', label: 'Intake Form' },
            ...
            { id: 'mh_5', type: 'emergency_contact', label: 'Emergency Contact' },
            { id: 'mh_6', type: 'pharmacy', label: 'Pharmacy' },
