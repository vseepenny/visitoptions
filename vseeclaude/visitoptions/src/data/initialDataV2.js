...
export const initialClinic = {
  ...
  defaultWorkflow: {
    ...
    steps: [
      ...
      { id: 'ws_4',     type: 'pharmacy', label: 'Pharmacy Picker', allowSearch: true, showMap: true, allowMailOrder: true, allowSkip: true },
    ...
    visitOptions: [
      {
        ...
        workflowOverride: {
          ...
          steps: [
            ...
            { id: 'mh_6', type: 'pharmacy', label: 'Pharmacy Picker', allowSearch: true, showMap: true, allowMailOrder: true, allowSkip: true },
